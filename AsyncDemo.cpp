...
BOOL CALLBACK AsyncDialog(HWND hX, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        SetDlgItemText(hX, IDC_URL1, L"https://www.bing.com");
...
BOOL Header(REQUEST_CONTEXT *cpContext)
{
    ...
    {
        SetDlgItemText(cpContext->hWindow, cpContext->nHeader, (LPWSTR)lpOutBuffer);
    }
...
void __stdcall AsyncCallback(HINTERNET hInternet,
                             DWORD_PTR dwContext,
